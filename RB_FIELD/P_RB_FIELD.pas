...
uses
  ...
  FMTBcd, SqlExpr, Provider, ComCtrls, JvExControls, JvInstallLabel,midaslib,
...
begin
 try
    ...
    Begin
      ...
      conexao.Params.Values['DataBase'] := EDSERVIDOR.Text+':'+EDCAMINHO.Text;
    ...
    on E: Exception do
    begin
      ShowExcessao(E, 'Não foi possível Conectar à '+EDSERVIDOR.Text + EDCAMINHO.Text + ' !');
    end;
  end;
end;
...
begin
  ...
  EDCAMINHO.Text := 'C:\DATA\DBDATA\PUMA\SAMAR_SORRISO\PUMA.FDB';
